        ...
        <div class="d-none flex-sm-fill d-sm-flex align-items-sm-center justify-content-sm-between">
            ...
            <div>
                <ul class="pagination">
                    ...
                    @else
                        <li class="page-item">
                            <a class="page-link bg-dark text-white border-white"
                            ...
                            @foreach ($element as $page => $url)
                                @if ($page == $paginator->currentPage())
                                    <li class="page-item active" aria-current="page"><span
                                            class="page-link bg-dark">{{ $page }}</span></li>
                                @else
                                    <li class="page-item"><a class="page-link bg-dark text-secondary"
                                            href="{{ $url }}">{{ $page }}</a></li>
                                @endif
                            @endforeach
                        @endif
                    ...
                    @else
                        <li class="page-item disabled" aria-disabled="true" aria-label="@lang('pagination.next')">
                            <span class="page-link bg-dark text-secondary" aria-hidden="true">&rsaquo;</span>
                        </li>
                    @endif
                </ul>
            </div>
